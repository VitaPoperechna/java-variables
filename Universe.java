public class Universe {
    public static void main(String[] args) {
        ...
        //Escribe aquí tu código
        System.out.println("Hay " + ((long)milkyWay + (long)andromeda) + " de estrellas en Andrómeda y en la Vía Láctea juntas.");
